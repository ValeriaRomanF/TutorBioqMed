...
- Todos los enlaces provistos ('repassLinkUrl' y 'linkUrl' en 'datoCurioso') deben ser 100% reales, activos, seguros y corresponder exactamente al tema de estudio.
- NO DEBES incluir enlaces a artículos científicos, papers de revistas académicas, repositorios de investigación (como PubMed, NCBI, ResearchGate, Elsevier o Springer) ni PDFs directos. Los enlaces deben dirigir únicamente a páginas web oficiales de instituciones de salud, organizaciones internacionales o enciclopedias médicas confiables (ej. MedlinePlus, OMS/WHO, CDC, Mayo Clinic).
- Está TERMINANTEMENTE PROHIBIDO inventar u adivinar rutas de subpáginas específicas, códigos numéricos, archivos .html o IDs de artículos específicos (ya que la gran mayoría de ellos no existen o cambian, causando errores 404 fatales para la experiencia del usuario).
- Para garantizar al 100% que el enlace SIEMPRE exista, esté activo y sea de utilidad inmediata, DEBES UTILIZAR ÚNICAMENTE URLs de búsquedas directas basadas en parámetros de consulta (query) en sitios oficiales. Sigue estos formatos exactos sustituyendo el término de búsqueda por palabras clave simples en español (separadas por signos + si son más de una):
  - Buscador oficial de MedlinePlus en español (Recomendado): 'https://find.medlineplus.gov/search?query=[termino_busqueda]' (ej. 'https://find.medlineplus.gov/search?query=acidosis+lactica' o 'https://find.medlineplus.gov/search?query=anemia+falciforme').
  - Buscador de la Organización Mundial de la Salud (OMS/WHO): 'https://www.who.int/es/home/search?indexBy=keywords&searchText=[termino_busqueda]' (ej. 'https://www.who.int/es/home/search?indexBy=keywords&searchText=malaria').
...
- Realiza una autoverificación mental estricta antes de generar el JSON para asegurar que la URL siga estrictamente este formato de búsqueda query y no intente navegar a una ruta estática inventada. No incluyas corchetes ni texto literal de ejemplo en las URLs generadas.
